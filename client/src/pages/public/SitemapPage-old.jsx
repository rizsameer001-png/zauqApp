...
//           axios.get('/api/poems?limit=5000'),
//           axios.get('/api/authors?limit=5000'),
//           axios.get('/api/books?limit=5000'),
//           axios.get('/api/blogs?limit=5000')
//         ]);
...
//         // Set response headers and render XML
//         document.body.innerHTML = xmlContent;
//         document.contentType = 'application/xml';
//       } catch (error) {
//         console.error('Error generating sitemap:', error);
//         document.body.innerHTML = '<?xml version="1.0" encoding="UTF-8"?><error>Unable to generate sitemap</error>';
//       }
//     };
