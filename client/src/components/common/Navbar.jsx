...
//premium-working smaal changes-admin switch button missing
// client/src/components/layout/Navbar.jsx
...
//   const logo =
//     'https://res.cloudinary.com/dp8wwgs1y/image/upload/v1780172847/lms/banners/yhwihcwidhh6f6hjxott.png'
...
//     { path: '/authors', label: t('common.authors'), icon: User },
//     { path: '/books', label: t('common.books'), icon: Bookmark },
//     { path: '/audio', label: t('common.audio', 'Audio'), icon: Headphones },
//     { path: '/videos', label: t('common.videos'), icon: Video },
//   ]
...
//           {/* 🔥 NAV LINKS (same, tighter + sharper) */}
//           <div className="hidden md:flex items-center gap-0.5">
//             {navLinks.map((link) => (
//               <Link
//                 key={link.path}
//                 to={link.path}
//                 className="relative px-3 py-2 text-[14px] font-bold text-gray-900 rounded-lg transition group hover:text-amber-600"
//               >
//                 <div className="flex items-center gap-1.5">
//                   <link.icon className="h-4 w-4 text-gray-800 group-hover:text-amber-600" />
//                   {link.label}
//                 </div>

//                 {/* sharp underline */}
//                 <span className="absolute left-1/2 bottom-0 w-0 h-[2px] bg-amber-500 transition-all group-hover:w-3/4 group-hover:left-1/8"></span>
//               </Link>
//             ))}
//           </div>

//           {/* 🔥 RIGHT SIDE (same logic, spacing fixed) */}
...
//               <button
//                 onClick={() => setIsLangOpen(!isLangOpen)}
//                 className="flex items-center gap-1 px-2 py-1.5 rounded-lg hover:bg-amber-50 transition"
//               >
...
//               {isLangOpen && (
//                 <div className="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded-lg shadow-sm">
//                   {LANGUAGES.map((lang) => (
//                     <button
//                       key={lang.code}
//                       onClick={() => {
...
//               <button
//                 onClick={logout}
//                 className="px-3 py-1.5 text-sm font-semibold text-red-600 rounded-lg hover:bg-red-50"
//               >
//                 Logout
//               </button>
//             ) : (
//               <Link
//                 to="/login"
//                 className="px-3 py-1.5 text-sm font-bold text-white bg-amber-500 rounded-lg hover:bg-amber-600 whitespace-nowrap"
//               >
//                 Sign In
//               </Link>
//             )}
...
//               to={link.path}
//               onClick={() => setIsMenuOpen(false)}
//               className="block px-3 py-2 rounded-lg font-semibold text-gray-900 hover:bg-gray-100"
//             >
//               {link.label}
//             </Link>
//           ))}
