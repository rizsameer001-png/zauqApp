...
//       // Return the response as-is, it should already have the correct structure
//       return response.data;
//     } catch (error) {
...
//   // Analyze poem content directly (for CMS / real-time analysis)
//   analyzePoemContent: (data) => {
//     if (!data.poemText || !data.poemText.trim()) {
//       return Promise.reject(new Error('Poem text is required'));
//     }
...
//   // Get full AI analysis for a poem (literary analysis) - EXISTING
//   getAIAnalysis: async (slug) => {
//     if (!slug) {
//       return Promise.reject(new Error('Slug is required'));
//     }
...
//   // ============================================
//   // NEW: Hugging Face Analysis with Fallback
//   // ============================================

//   // Get AI analysis using Hugging Face with fallback
//   // This is a NEW method that doesn't interfere with existing getAIAnalysis
...
//       // Return fallback on error - never reject, always return something
//       return {
//         success: false,
//         data: getFallbackAnalysisData(),
//         provider: 'fallback',
...
//   // Convenience method to get analysis by slug (fetches poem first, then analysis)
...
//     try {
//       // First get the poem to get its ID
...
//       // Then get analysis using poem ID
...
//   // Analyze poem content directly (for CMS / real-time analysis) - EXISTING
//   analyzePoemContent: (data) => {
//     if (!data.poemText || !data.poemText.trim()) {
//       return Promise.reject(new Error('Poem text is required'));
//     }
