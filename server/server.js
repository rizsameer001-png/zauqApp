...
import adRoutes from './routes/ad.routes.js';
import sitemapRoutes from './routes/sitemap.routes.js';
import creatorUploadRoutes from './routes/creator.upload.routes.js';
//import audioAnalyticsRoutes from './routes/audio.analytics.routes.js';
import creatorAudioRoutes from './routes/creator.audio.routes.js';
...
app.use('/api/creator/upload/', strictLimiter);
...
// Analytics
//app.use('/api/analytics', analyticsRoutes);
//app.use('/api/audio-analytics', audioAnalyticsRoutes);
...
// Add this route
app.use('/api/creator/audio', creatorAudioRoutes);
...
// Creator routes test
app.get('/api/creator-test', (req, res) => {
  res.json({
    success: true,
    message: 'Creator routes are configured',
    availableEndpoints: [
      // Dashboard
      ...
      'GET    /api/creator/poems',
      'GET    /api/creator/books',
      'GET    /api/creator/audio',
      'GET    /api/creator/videos',
      'GET    /api/creator/content/:type/:id',
      'PUT    /api/creator/content/:type/:id',
      'DELETE /api/creator/content/:type/:id',
      
      // Bulk Operations
      'POST   /api/creator/content/bulk-delete',
      'POST   /api/creator/content/bulk-update-status',
      
      // Analytics
      'GET    /api/creator/content/analytics',
      'GET    /api/creator/content/top',
      'GET    /api/creator/earning-reports',
      
      // Audio Analytics
      'GET    /api/creator/audio-analytics',
      'GET    /api/creator/audio-analytics/:id',
      
      // Upload
      'POST   /api/creator/upload/poetry',
      'POST   /api/creator/upload/ebook',
      'POST   /api/creator/upload/audio',
      'POST   /api/creator/upload/video',
      'GET    /api/creator/upload-presets',
      'POST   /api/creator/validate-file',
      'GET    /api/creator/upload-status',
      ...
      'GET    /api/creator/notifications/unread-count',
      'PATCH  /api/creator/notifications/:id/read',
      'PATCH  /api/creator/notifications/mark-all-read',
      'DELETE /api/creator/notifications/:id',
      'DELETE /api/creator/notifications/clear-all',
      
      // Playlists
      'GET    /api/creator/playlists',
      'POST   /api/creator/playlists',
      'GET    /api/creator/playlists/:id',
      'PUT    /api/creator/playlists/:id',
      'DELETE /api/creator/playlists/:id',
      'POST   /api/creator/playlists/:id/add',
      'DELETE /api/creator/playlists/:id/remove',
      'PATCH  /api/creator/playlists/:id/reorder',
      'GET    /api/creator/playlists/:id/analytics',
      'POST   /api/creator/playlists/:id/duplicate'
    ]
  });
});
...
app.get('/', (req, res) => {
  res.json({
    ...
    documentation: 'API documentation available at /api/health/detailed'
  });
});
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`\n🎵 AUDIO ROUTES:`);
      console.log(`   GET    /api/audio`);
      console.log(`   GET    /api/audio/type/:type`);
      console.log(`   GET    /api/audio/occasion/:occasion`);
      console.log(`   GET    /api/audio/stats`);
      console.log(`   GET    /api/audio/featured`);
      console.log(`   GET    /api/audio/:slug`);
      console.log(`   GET    /api/audio/:slug/stream`);
      ...
      console.log(`   GET    /api/videos/:slug`);
      console.log(`   GET    /api/videos/:slug/stream`);
      console.log(`   POST   /api/videos (admin only)`);
      
      console.log(`\n👤 CREATOR ROUTES:`);
      console.log(`   GET    /api/creator/dashboard`);
      console.log(`   GET    /api/creator/stats`);
      console.log(`   GET    /api/creator/analytics`);
      console.log(`   GET    /api/creator/revenue`);
      console.log(`   GET    /api/creator/content`);
      console.log(`   POST   /api/creator/upload/poetry`);
      console.log(`   POST   /api/creator/upload/ebook`);
      console.log(`   POST   /api/creator/upload/audio`);
      console.log(`   POST   /api/creator/upload/video`);
      console.log(`   GET    /api/creator/notifications`);
      console.log(`   GET    /api/creator/playlists`);
      console.log(`   GET    /api/creator/audio-analytics`);
      console.log(`   PUT    /api/creator/profile`);
      
      console.log(`\n⚙️ APP SETTINGS ROUTES:`);
      console.log(`   GET    /api/app-settings - Get all settings`);
      console.log(`   PUT    /api/app-settings - Update all settings`);
      console.log(`   POST   /api/app-settings/reset - Reset to defaults`);
      console.log(`   GET    /api/app-settings/:key - Get single setting`);
      ...
      console.log(`\n❤️  Health check: http://localhost:${PORT}/api/health`);
      console.log(`🎵 Audio test: http://localhost:${PORT}/api/audio-test`);
      console.log(`👤 Creator test: http://localhost:${PORT}/api/creator-test`);
      console.log(`📁 Upload test: http://localhost:${PORT}/api/upload-test`);
      console.log(`⚙️  App Settings: http://localhost:${PORT}/api/app-settings`);
    });
  } catch (error) {
    console.error('❌ Server startup failed:', error);
    process.exit(1);
